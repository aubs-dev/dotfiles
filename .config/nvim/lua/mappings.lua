...
keymap.set("n", "<leader>fd", ":lua require('telescope.builtin').diagnostics(require('telescope.themes').get_dropdown{layout_config = {width = 0.9}, no_unlisted = true, line_width = 112, disable_coordinates = true})<CR>", opts) -- [F]ind [D]iagnostics
